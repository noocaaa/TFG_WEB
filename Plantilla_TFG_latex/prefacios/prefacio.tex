...
Este trabajo presenta el diseño, desarrollo y evaluación de un ITS enfocado en la enseñanza de programación a niños. El sistema propuesto aplica una automatización en la corrección de los ejercicios con tal de poder ofrecer una buena retroalimentación del entendimiento del estudiante en tiempo real. Asimismo, es capaz de adaptarse a las necesidades individuales de los estudiantes y monitorizar su progreso. 

El proceso de desarrollo del ITS se llevó a cabo en diversas fases. En primer lugar, se establecieron los fundamentos pedagógicos y se identificaron las necesidades específicas del público infantil. Posteriormente, se integraron listtablename técnicas avanzadas de corrección y elección de ejercicios con tal de garantizar la adaptabilidad y efectividad del sistema.

Para evaluar la eficacia del ITS, se realizaron pruebas con un grupo de estudiantes, en colaboración con la empresa CODELEARN S.L. Los resultados iniciales sugieren una posible mejora significativa en la retención de conocimientos y en el rendimiento académico de los participantes, validando así la propuesta de este TFG.
